...
SetPrivateProfileString('Game Options','Last Save PST','000000001-Швидкозбереження')
...
SetPrivateProfileString('Program Options','Maximum Frame Rate','50')
...
SetPrivateProfileString('Graphics','version','OpenGL version 4.6.0 Compatibility Profile Context 23.19.14.08.240820 - build XXXX')
...
SetPrivateProfileString('Graphics','renderer','AMD Radeon(TM) Graphics')
...
SetPrivateProfileString('Language','Text','uk_UA')
...
SetPrivateProfileString('Fonts','Zoom','123')
